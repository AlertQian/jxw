<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:41:"./application/admin\view\index_index.html";i:1509078377;s:42:"./application/admin\view\index_header.html";i:1507643832;s:42:"./application/admin\view\index_footer.html";i:1504421376;}*/ ?>
<!DOCTYPE html>
<html>
<head>  
...
<div class="header">
  <div class="main">
    <a class="logo" href="<?php echo url('index/index'); ?>" title="Tpt-Content内容管理系统"><img src="__ADMIN__/img/logo.png"></a>
	<span></span>
    <div class="nav-user">
      <a class="avatar">
...
<ul class="layui-nav layui-nav-tree">
    ...
    <dl class="layui-nav-child">
      <dd><a href="http://www.tpt360.com/zhuti.html" target="_blank"><i class="layui-icon">&#xe61b;</i>主题模板</a></dd>
	  <dd><a href="http://wenda.tpt360.com/" target="_blank"><i class="layui-icon">&#xe600;</i>疑难问答</a></dd>
    </dl>
    </li>
</ul>
</div>
