<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:35:"./template/default/login_index.html";i:1506499759;s:36:"./template/default/index_header.html";i:1506500650;s:37:"./template/default/public_gradeh.html";i:1504321935;s:36:"./template/default/index_footer.html";i:1506483663;}*/ ?>
<!DOCTYPE html>
<html>
<head>  
<title>登录 - Templet360</title>
...
<?php if(config('web.WEB_LOG') == 3): ?>或者使用QQ账号登录<a class="login" href="javascript:void(0)"><i class="iconfont" style="font-size: 24px;margin-left: 8px;position: relative;top: 2px;color: #7CA9C9;">&#xe606;</i><?php endif; ?>
</div>
</div> 
</div>
</div>
